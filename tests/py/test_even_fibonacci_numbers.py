...
"""
import pytest
from even_fibonacci_numbers import fibonacci_less_than


@pytest.mark.parametrize("test_limit,expected_length",
    [(0, 0), (1, 0), (2, 1), (3, 2), (4, 3), (89, 9), (90, 10)])
...
@pytest.mark.parametrize("test_limit,expected_last_number",
    [(2, 1), (3, 2), (4, 3), (5, 3), (6, 5), (7, 5),
        (8, 5), (9, 8), (14, 13), (22, 21), (35, 34), (56, 55), (90, 89)])
...
@pytest.mark.parametrize("test_limit,expected_sum",
    [(0, 0), (1, 0), (2, 0), (3, 2), (4, 2), (5, 2), (6, 2), (8, 2), (9, 10), (90, 44)])
